...
- Set the Expiration period for this personal access token. Once the expiration period has ended, you'll have to go through these steps to generate a new personal access token.
